...
class PerioRunner(BaseTimeSeriesForecastingRunner):
    ...
    def forward(self, data: tuple, epoch:int = None, iter_num: int = None, train:bool = True, **kwargs) -> tuple:
        ...
        origin_future = future_data

        history_data = self.select_input_features(history_data)

        # feed forward
        predict_value, real_value = self.model(history_data=history_data, future_data=origin_future, batch_seen=iter_num, epoch=epoch)
