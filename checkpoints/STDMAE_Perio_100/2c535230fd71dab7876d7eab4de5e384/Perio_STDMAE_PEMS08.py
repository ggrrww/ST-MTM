...
from .stdmae_arch import STDMAE_perio
...
# ================= general ================= #
CFG.DESCRIPTION = "STDMAE_PERIO(PEMS08) configuration"
...
# 需要补充
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "STDMAE_Perio"
CFG.MODEL.ARCH = STDMAE_perio
adj_mx, _ = load_adj("datasets/" + CFG.DATASET_NAME + "/adj_mx.pkl", "doubletransition")
CFG.MODEL.PARAM = {
    "dataset_name": CFG.DATASET_NAME,
    "pre_trained_tmae_path": "checkpoints/Perio_TMAE_200/4a53140d508454bc731239bb2e438708/Perio_TMAE_best_val_MAE.pt",  
