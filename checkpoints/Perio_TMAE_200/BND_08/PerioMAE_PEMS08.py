...
from .stdmae_arch import Perio_Pretraining_Transformer2
from .stdmae_runner import PerioRunner
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "Perio_TMAE"
CFG.MODEL.ARCH = Perio_Pretraining_Transformer2
CFG.MODEL.PARAM = {
    "num_nodes": 170,
    'input_len':12,
    "in_channel":1,
